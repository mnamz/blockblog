            ...
            <div class="grid grid-cols-2 sm:grid-cols-4 sm:grid-rows-6 gap-5">
                ...
                <div
                    ...
                    <div class="header-img sm:w-2/6">
                        <img class="rounded-lg h-full w-full object-cover overflow-visible"
                            src="../../../storage/images/memojiAlep.png" alt="A picture of me" />
                    </div>
                ...
                <div class="panel p-0 col-span-2 sm:col-span-1">
                    ...
                    <div class="techStack-carousel pb-2.5 sm:py-3">
                        <div class="px-2">
                            <img src="../../../storage/images/Cloud.png" alt="" />
                        </div>
                        <div class="px-2">
                            <img src="../../../storage/images/Drupal.png" alt="" />
                        </div>
                        <div class="px-2">
                            <img src="../../../storage/images/Flutter.png" alt="" />
                        </div>
                        <div class="px-2">
                        ...
                        <div class="px-2">
                            <img src="../../../storage/images/Jquery.png" alt="" />
                        </div>
                    </div>
                </div>
